...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(1).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(2).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(3).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(5).png)  

<p>잠시 후 <span style="background-color: #dddddd;">GCP Console</span>이 이 탭에서 열린다.</p>

![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(6).png)  

<p>왼쪽 상단에 탐색 메뉴를 클릭해서 메뉴를 살펴보자!</p>

![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(7).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(8).png)  

<p><span>(2) </span><b>Continue를</b><span> 클릭하자.</span></p>

![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(9).png)  

<p><span>환경을 프로비저닝하고 연결하는 데 약간의 시간이 걸린다. </span></p>
<p><span>연결되면 이미 인증되었으며 프로젝트는<span>&nbsp;</span><b>PROJECT_ID&nbsp;</b>PROJECT_ID로 설정된다.</span></p>
<p>&nbsp;</p>

![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(10).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(10-1).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(11).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(12).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(14).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(15).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(16).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(17).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(18).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(19).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(19-1).png)  

<p><b><span style="background-color: #f6e199;">실습의 진행 상황 확인하기</span></b></p>

![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(20-1).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(21).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(21-1).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(22).png)  
...
![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(23).png)  

<p>&nbsp;</p>
<h2><span style="background-color: #99cefa;">가상 머신 만들기 실습 완료 확인&nbsp;</span></h2>
<p>GCP Essentials로 돌아오면 정상적으로 실습이 완료된 것을 확인할 수 있다!</p>

![img](/docs/.vuepress/public/images/img-gcp/GCP가상머신만들기(24).png)  
