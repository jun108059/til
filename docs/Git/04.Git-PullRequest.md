...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(1).png)   
![img](/docs/.vuepress/public/images/img-git/github-pull-request(2).png)   


<p>2. URL이 변경된 것을 확인할 수 있다.</p>

![img](/docs/.vuepress/public/images/img-git/github-pull-request(3).png)   
...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(4).png)   
...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(5).png)   
...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(6).png)   
...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(7).png)   

<p>&nbsp;</p>

![img](/docs/.vuepress/public/images/img-git/github-pull-request(8).png)   
...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(9).png)   

![img](/docs/.vuepress/public/images/img-git/github-pull-request(10).png)   
...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(11).PNG)   

> 브랜치를 변경하고 지난 세션에서 생성했던 본인이름.md 파일에 한 줄을 더 추가해주세요!  

![img](/docs/.vuepress/public/images/img-git/github-pull-request(12).PNG)   
...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(13).PNG)  
...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(14).PNG)   
...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(15).PNG)   
![img](/docs/.vuepress/public/images/img-git/github-pull-request(16).PNG)   

작성이 완료되었다면 우측 하단에 있는 `Create pull request` 버튼을 누르세요.

![img](/docs/.vuepress/public/images/img-git/github-pull-request(17).PNG)   
...
![img](/docs/.vuepress/public/images/img-git/github-pull-request(18).PNG)  

> 팀장은 `Files changed`탭을 누르면 여러분이 수정한 file 내용을 확인할 수 있어요.


![img](/docs/.vuepress/public/images/img-git/github-pull-request(19).PNG)  
